...
class Store:
    ...
    def get_department(self, department_id):
        ...
        raise StoreException("Department not found")
    ...
    def create_product(self, product: Product):
        ...
        if department_id not in self.departments:
            raise StoreExceptionInvalidID(f"There is no Department with id:{department_id}")
        else:
    ...
    def get_selected_product(self, product_id):
        ...
        raise StoreException("Product not found")
